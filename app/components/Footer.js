      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-white mb-2">SunSolar Company</h3>
            ...
            <div className="mb-6">
              ...
              <form className="flex flex-col gap-3">
                <input
                  ...
                  className="px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent text-sm transition-all duration-200 text-white placeholder-gray-400"
                />
                <button 
                  type="submit" 
        ...
        {/* Payment Methods */}
        <div className="mb-8">
          <h4 className="text-lg font-semibold text-white mb-4">Secure Payment Methods</h4>
